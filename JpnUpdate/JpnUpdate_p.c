...
/* Object interface: IJpnUpdateService, ver. 0.0,
   GUID={0x54C1CCF8,0xAC76,0x4754,{0xA7,0x6E,0xD4,0x39,0x80,0xD5,0xC8,0x20}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IJpnUpdateService_ServerInfo;
...
static const unsigned short IJpnUpdateService_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IJpnUpdateService_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IJpnUpdateService_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IJpnUpdateService_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IJpnUpdateService_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(8) _IJpnUpdateServiceProxyVtbl = 
{
    &IJpnUpdateService_ProxyInfo,
    &IID_IJpnUpdateService,
    ...
    (void *)-1 /* IJpnUpdateService::Execute */
};


static const PRPC_STUB_FUNCTION IJpnUpdateService_table[] =
{
...
CInterfaceStubVtbl _IJpnUpdateServiceStubVtbl =
{
    &IID_IJpnUpdateService,
    &IJpnUpdateService_ServerInfo,
    8,
    &IJpnUpdateService_table[-3],
...
const CInterfaceProxyVtbl * _JpnUpdate_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IJpnUpdateServiceProxyVtbl,
    0
};

const CInterfaceStubVtbl * _JpnUpdate_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IJpnUpdateServiceStubVtbl,
    0
};

PCInterfaceName const _JpnUpdate_InterfaceNamesList[] = 
{
    "IJpnUpdateService",
    0
};

const IID *  _JpnUpdate_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _JpnUpdate_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _JpnUpdate, pIID, n)

int __stdcall _JpnUpdate_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_JpnUpdate_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo JpnUpdate_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _JpnUpdate_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _JpnUpdate_StubVtblList,
    (const PCInterfaceName * ) & _JpnUpdate_InterfaceNamesList,
    (const IID ** ) & _JpnUpdate_BaseIIDList,
    & _JpnUpdate_IID_Lookup, 
    1,
    2,
