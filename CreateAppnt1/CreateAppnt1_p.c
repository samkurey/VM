...
/* Object interface: ICreateAppnt1Service, ver. 0.0,
   GUID={0xD17CDF01,0x01AD,0x42C7,{0xB0,0x9A,0x1E,0xB7,0x63,0xA6,0xD9,0x3F}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ICreateAppnt1Service_ServerInfo;
...
static const unsigned short ICreateAppnt1Service_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO ICreateAppnt1Service_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &ICreateAppnt1Service_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO ICreateAppnt1Service_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &ICreateAppnt1Service_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(8) _ICreateAppnt1ServiceProxyVtbl = 
{
    &ICreateAppnt1Service_ProxyInfo,
    &IID_ICreateAppnt1Service,
    ...
    (void *)-1 /* ICreateAppnt1Service::Execute */
};


static const PRPC_STUB_FUNCTION ICreateAppnt1Service_table[] =
{
...
CInterfaceStubVtbl _ICreateAppnt1ServiceStubVtbl =
{
    &IID_ICreateAppnt1Service,
    &ICreateAppnt1Service_ServerInfo,
    8,
    &ICreateAppnt1Service_table[-3],
...
const CInterfaceProxyVtbl * _CreateAppnt1_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICreateAppnt1ServiceProxyVtbl,
    0
};

const CInterfaceStubVtbl * _CreateAppnt1_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICreateAppnt1ServiceStubVtbl,
    0
};

PCInterfaceName const _CreateAppnt1_InterfaceNamesList[] = 
{
    "ICreateAppnt1Service",
    0
};

const IID *  _CreateAppnt1_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _CreateAppnt1_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _CreateAppnt1, pIID, n)

int __stdcall _CreateAppnt1_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_CreateAppnt1_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo CreateAppnt1_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _CreateAppnt1_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _CreateAppnt1_StubVtblList,
    (const PCInterfaceName * ) & _CreateAppnt1_InterfaceNamesList,
    (const IID ** ) & _CreateAppnt1_BaseIIDList,
    & _CreateAppnt1_IID_Lookup, 
    1,
    2,
