...
HRESULT CCreateAppnt1Service::Activate()
{
...
BOOL CCreateAppnt1Service::CanBePooled()
{
	return TRUE;
} 

void CCreateAppnt1Service::Deactivate()
{
...
STDMETHODIMP CCreateAppnt1Service::Execute(SAFEARRAY *pDataReq, SAFEARRAY **pDataResp)
{
...
/*
STDMETHODIMP CCreateAppnt1Service::InterfaceSupportsErrorInfo(REFIID riid)
{
