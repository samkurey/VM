...
/* Object interface: IGMPCEnquiryService, ver. 0.0,
   GUID={0x3531224D,0xD40D,0x4D2E,{0xB5,0xB6,0x9A,0x23,0xCD,0x1F,0x1C,0xCE}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IGMPCEnquiryService_ServerInfo;
...
static const unsigned short IGMPCEnquiryService_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IGMPCEnquiryService_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IGMPCEnquiryService_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IGMPCEnquiryService_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IGMPCEnquiryService_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(8) _IGMPCEnquiryServiceProxyVtbl = 
{
    &IGMPCEnquiryService_ProxyInfo,
    &IID_IGMPCEnquiryService_L2,
    ...
    (void *)-1 /* IGMPCEnquiryService::Execute */
};


static const PRPC_STUB_FUNCTION IGMPCEnquiryService_table[] =
{
...
CInterfaceStubVtbl _IGMPCEnquiryServiceStubVtbl =
{
    &IID_IGMPCEnquiryService_L2,
    &IGMPCEnquiryService_ServerInfo,
    8,
    &IGMPCEnquiryService_table[-3],
...
const CInterfaceProxyVtbl * _GMPCEnquiry_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IGMPCEnquiryServiceProxyVtbl,
    0
};

const CInterfaceStubVtbl * _GMPCEnquiry_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IGMPCEnquiryServiceStubVtbl,
    0
};

PCInterfaceName const _GMPCEnquiry_InterfaceNamesList[] = 
{
    "IGMPCEnquiryService",
    0
};

const IID *  _GMPCEnquiry_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _GMPCEnquiry_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _GMPCEnquiry, pIID, n)

int __stdcall _GMPCEnquiry_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_GMPCEnquiry_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo GMPCEnquiry_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _GMPCEnquiry_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _GMPCEnquiry_StubVtblList,
    (const PCInterfaceName * ) & _GMPCEnquiry_InterfaceNamesList,
    (const IID ** ) & _GMPCEnquiry_BaseIIDList,
    & _GMPCEnquiry_IID_Lookup, 
    1,
    2,
