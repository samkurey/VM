...
const IID *  _Jpnhg3PymtRevUpd_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _Jpnhg3PymtRevUpd_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Jpnhg3PymtRevUpd, pIID, n)

int __stdcall _Jpnhg3PymtRevUpd_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_Jpnhg3PymtRevUpd_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo Jpnhg3PymtRevUpd_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Jpnhg3PymtRevUpd_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Jpnhg3PymtRevUpd_StubVtblList,
    (const PCInterfaceName * ) & _Jpnhg3PymtRevUpd_InterfaceNamesList,
    (const IID ** ) & _Jpnhg3PymtRevUpd_BaseIIDList,
    & _Jpnhg3PymtRevUpd_IID_Lookup, 
    1,
    2,
