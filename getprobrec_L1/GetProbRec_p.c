...
/* Object interface: IGetProbRecService, ver. 0.0,
   GUID={0x0E06959A,0xCA0D,0x4734,{0xA5,0xB1,0x4F,0x35,0xEF,0xD6,0x2E,0xAB}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IGetProbRecService_ServerInfo;
...
static const unsigned short IGetProbRecService_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IGetProbRecService_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IGetProbRecService_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IGetProbRecService_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IGetProbRecService_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(8) _IGetProbRecServiceProxyVtbl = 
{
    &IGetProbRecService_ProxyInfo,
    &IID_IGetProbRecService_L1,
    ...
    (void *)-1 /* IGetProbRecService::Execute */
};


static const PRPC_STUB_FUNCTION IGetProbRecService_table[] =
{
...
CInterfaceStubVtbl _IGetProbRecServiceStubVtbl =
{
    &IID_IGetProbRecService_L1,
    &IGetProbRecService_ServerInfo,
    8,
    &IGetProbRecService_table[-3],
...
const CInterfaceProxyVtbl * _GetProbRec_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IGetProbRecServiceProxyVtbl,
    0
};

const CInterfaceStubVtbl * _GetProbRec_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IGetProbRecServiceStubVtbl,
    0
};

PCInterfaceName const _GetProbRec_InterfaceNamesList[] = 
{
    "IGetProbRecService_L1",
    0
};

const IID *  _GetProbRec_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _GetProbRec_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _GetProbRec, pIID, n)

int __stdcall _GetProbRec_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_GetProbRec_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo GetProbRec_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _GetProbRec_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _GetProbRec_StubVtblList,
    (const PCInterfaceName * ) & _GetProbRec_InterfaceNamesList,
    (const IID ** ) & _GetProbRec_BaseIIDList,
    & _GetProbRec_IID_Lookup, 
    1,
    2,
