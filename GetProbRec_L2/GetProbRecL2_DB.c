...
static unsigned int sqlctx = 67410763;
...
EASONCODE ,PROBLSERNO ,PROBLSTAT ,PROBLREMARKS ,TO_CHAR(PROBLSOLVEDATE,'DDMMYY\
YY HH24MISS') ,USERID ,WSID ,TO_CHAR(ACTDATETIME,'DDMMYYYY HH24MISS') ,ACTREMA\
RKS ,ACTUSERID ,BRANCHCODE ,TXNCODE ,LEGACYTYPE ,APPLID  from PROBL_RECORD whe\
re APPLID=:b0           ";
...
{12,4274,178,0,0,
5,0,0,1,134,0,4,255,0,0,2,1,0,1,0,2,3,0,0,1,97,0,0,
28,0,0,2,144,0,4,305,0,0,3,1,0,1,0,2,97,0,0,2,1,0,0,1,97,0,0,
55,0,0,3,62,0,4,447,0,0,2,1,0,1,0,1,97,0,0,2,3,0,0,
78,0,0,4,95,0,4,454,0,0,2,1,0,1,0,2,3,0,0,1,97,0,0,
101,0,0,5,99,0,4,523,0,0,2,1,0,1,0,2,3,0,0,1,97,0,0,
124,0,0,6,88,0,4,628,0,0,2,1,0,1,0,2,1,0,0,1,97,0,0,
147,0,0,7,61,0,4,652,0,0,2,1,0,1,0,2,3,0,0,1,97,0,0,
170,0,0,8,86,0,5,660,0,0,1,1,0,1,0,1,97,0,0,
189,0,0,9,61,0,4,1001,0,0,2,1,0,1,0,2,3,0,0,1,97,0,0,
212,0,0,10,131,0,4,1256,0,0,2,1,0,1,0,2,97,0,0,1,97,0,0,
235,0,0,11,458,0,4,1287,0,0,18,1,0,1,0,2,97,0,0,2,1,0,0,2,97,0,0,2,97,0,0,2,97,
0,0,2,97,0,0,2,9,0,0,2,97,0,0,2,9,0,0,2,97,0,0,2,3,0,0,2,9,0,0,2,1,0,0,2,9,0,0,
2,3,0,0,2,97,0,0,2,97,0,0,1,97,0,0,
322,0,0,12,86,0,5,1322,0,0,1,1,0,1,0,1,97,0,0,
341,0,0,13,1698,0,4,1571,0,0,62,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,97,0,0,2,3,0,
...
2,97,0,0,1,97,0,0,
604,0,0,14,66,0,4,2151,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
627,0,0,15,356,0,9,2276,0,0,1,1,0,1,0,1,97,0,0,
646,0,0,15,0,0,13,2299,0,0,20,0,0,1,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,97,0,0,
...
741,0,0,15,0,0,15,2317,0,0,0,0,0,1,0,
756,0,0,15,0,0,15,2432,0,0,0,0,0,1,0,
771,0,0,16,53,0,5,2456,0,0,1,1,0,1,0,1,97,0,0,
790,0,0,17,86,0,5,2478,0,0,2,2,0,1,0,1,1,0,0,1,97,0,0,
813,0,0,18,229,0,4,2564,0,0,10,1,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,1,9,0,0,
868,0,0,19,64,0,4,2633,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
891,0,0,20,129,0,9,2726,0,0,1,1,0,1,0,1,9,0,0,
910,0,0,20,0,0,15,2741,0,0,0,0,0,1,0,
925,0,0,20,0,0,13,2749,0,0,4,0,0,1,0,2,3,0,0,2,97,0,0,2,4,0,0,2,3,0,0,
956,0,0,20,0,0,15,2763,0,0,0,0,0,1,0,
971,0,0,20,0,0,15,2794,0,0,0,0,0,1,0,
986,0,0,21,143,0,9,2842,0,0,1,1,0,1,0,1,9,0,0,
1005,0,0,21,0,0,15,2857,0,0,0,0,0,1,0,
1020,0,0,21,0,0,13,2865,0,0,5,0,0,1,0,2,3,0,0,2,97,0,0,2,4,0,0,2,3,0,0,2,1,0,0,
1055,0,0,21,0,0,15,2880,0,0,0,0,0,1,0,
1070,0,0,21,0,0,15,2913,0,0,0,0,0,1,0,
1085,0,0,22,93,0,4,2960,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
1108,0,0,23,85,0,4,2980,0,0,3,1,0,1,0,2,3,0,0,2,97,0,0,1,9,0,0,
1135,0,0,24,334,0,9,3136,0,0,1,1,0,1,0,1,97,0,0,
1154,0,0,24,0,0,13,3158,0,0,18,0,0,1,0,2,3,0,0,2,97,0,0,2,97,0,0,2,9,0,0,2,97,
0,0,2,3,0,0,2,1,0,0,2,9,0,0,2,9,0,0,2,97,0,0,2,97,0,0,2,9,0,0,2,9,0,0,2,97,0,0,
2,97,0,0,2,97,0,0,2,97,0,0,2,97,0,0,
1241,0,0,24,0,0,15,3176,0,0,0,0,0,1,0,
};


/* $Header$ */
/************************************************************************/
/* Filename    : get_prob_rec_L2.pc										*/
/* Author      : Abhijeet Deshpande										*/
/* Description : This file contains database routines for				*/
/*				GET_PROB_REC_L2 service									*/
/************************************************************************/
...
int Get_Prob_Rec(GET_PROB_REC_L2_REQ_T *pReq, 
				GET_PROB_REC_L2_RESP_T **pResp, long *pRespSize,void * ctx)
{
	/* Variable declarations */
	GET_PROB_REC_L2_REQ_T *req; 
	GET_PROB_REC_L2_RESP_T *resp,*orig_resp,*new_resp;
	GET_PROB_REC_L2_RESP_T *temp_resp;
	...
	PROB_DETAILS2_T *probl_record;	//Added by Salmi on 11 Aug 2021 for My KAS Tamat Tempoh


	//for testing
	//FILE *fptr=NULL;
	//GET_PROB_REC_L2_RESP_T *test_resp;   
	...
	int  acnt=0;
	char genkpt = '\0';
	char old_appl_id[APP_ID_SIZE]={0}; //Added by Salmi on 11 Aug 2021 for My KAS Tamat Tempoh
	int  txncnt; //Added by Salmi on 11 Aug 2021 for My KAS Tamat Tempoh
...
// Modification for IJPN
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : Service initiated");
	#endif

	/* Set pointer to data received by the service */
	req = (GET_PROB_REC_L2_REQ_T *)pReq;

#ifdef DEBUG
	userlog("");
	userlog("GET_PROB_REC_L2 : REQUEST BUFFER");
	userlog("GET_PROB_REC_L2 : Branch/SSC Code - %s", req->header.branch_code);
	userlog("GET_PROB_REC_L2 : Workstation Id - %s", req->header.workstation_id);
	userlog("GET_PROB_REC_L2 : Application Id - %s", req->header.application_id);
	userlog("GET_PROB_REC_L2 : User Id - %s", req->header.user_id);
	userlog("GET_PROB_REC_L2 : Old Application Id - %s", req->application_id);  //Added by Salmi on 11 Aug 2021 for My KAS Tamat Tempoh
	userlog("GET_PROB_REC_L2 : q_tkt_no - %s", req->q_tkt_no);					//Added by Salmi on 11 Aug 2021 for My KAS Tamat Tempoh
	userlog("GET_PROB_REC_L2 : applicant_id_type - %s", req->applicant_id_type);//Added by Salmi on 11 Aug 2021 for My KAS Tamat Tempoh
...
#ifdef DEBUG
	userlog( "GET_PROB_REC_L2 : curr_date_time = %s\n", curr_date_time);	
#endif

	/* Set the program id */
	_itoa(GET_PROB_REC_L2_ID, program_id, 10);

#ifdef DEBUG
	userlog( "GET_PROB_REC_L2 : Program Id = %s\n", program_id);	
#endif
	...
	resp_length = sizeof(GET_PROB_REC_L2_RESP_T);

	resp = (GET_PROB_REC_L2_RESP_T *) malloc(resp_length);

	if (resp == NULL)
	{
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : malloc failed ");
	#endif

		/* Log the error */
		strcpy(prog_log.remarks,"GET_PROB_REC_L2 :  memory allocation failed");
		sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : Allocation of memory failed : ");
...
#ifdef DEBUG
	userlog("GET_PROB_REC_L2 : The address of resp buffer allocated is 0x%X",resp);
#endif
	...
	{
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : check header failed");
	#endif

		/* Log the error */
		sprintf(prog_log.remarks, "GET_PROB_REC_L2 : check_header failed with error code %d", ret_val);
	...
	if(req->applicant_id[0] != '\0')
	{
		...
		{
			#ifdef DEBUG
				userlog("GET_PROB_REC_L2 : Invalid Id Type specified in request buffer");
			#endif

			/* Log the error */
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Invalid Id Type specified in request buffer");
			sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : Invalid Id Type specified in request buffer");
			excep_log.termination_flag = 'Y';
			excep_log.severity = FATAL;
...
if(strcmp(req->header.application_id,"\0") == 0)
{
		...
		userlog("GET_PROB_REC_L2 : branchcode : %s",branchcode);

		/* Get the enqtype and check whether A or E or Blank
			and do the processing accordingly  */

/*  Commented this on 21/12/2009 for my express
...
*/
		...
		/* EXEC SQL SELECT COUNT(*) INTO :enqtypecnt
			...
			WHERE SSCBRANCHCODE = :branchcode
			AND   SENDFLAG = 'N'
			AND NVL(ENQTYPE,'Z') != 'M'  // NULL is not equal to M that is NVL is used here
			AND   ROWNUM = 1; */ 

{
  ...
  sqlstm.stmt = "select count(*)  into :b0  from APPNT_PROBL_DATA where (((S\
SCBRANCHCODE=:b1 and SENDFLAG='N') and NVL(ENQTYPE,'Z')<>'M') and ROWNUM=1)";
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
		 #ifdef DEBUG
			userlog(" GET_PROB_REC_L2 : Selecting count from APPNT_PROBL_DATA failed : %s", SQLMSG);
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Selecting count from APPNT_PROBL_DATA failed");
			sprintf(excep_log.error_msg, "GET_PROB_REC_L2 : Selecting count from APPNT_PROBL_DATA failed : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
		...
		else if((SQLCODE == 1403) || (enqtypecnt==0))
		{
			...
			#ifdef DEBUG
				userlog(" GET_PROB_REC_L2 : NO DATA FOUND in APPNT_PROBL_DATA table while selecting count: %s", SQLMSG);
				userlog(" GET_PROB_REC_L2 : Returning resp->enqtype_ind as NULL ");
			#endif
...
where (((SSCBRANCHCODE=:b2 and SENDFLAG='N') and NVL(ENQTYPE,'Z')<>'M') and RO\
WNUM=1)";
  sqlstm.iters = (unsigned int  )1;
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : appl_id : %s",appl_id);
		userlog("GET_PROB_REC_L2 : enqtype : %c",enqtype);
	#endif
...
//   This code is added by kasi for Express card on 26/01/2007
  if(enqtype == 'X')
  {
	...
	new_resp = (GET_PROB_REC_L2_RESP_T *) malloc( resp_length);

	if (new_resp == NULL)
	{
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : malloc failed for enqtype=X ");
	#endif

		/* Log the error */
		strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Memory allocation failed for enqtype = X");
		sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : Allocation of memory failed for enqtype = X :");
		excep_log.termination_flag = 'Y';
		excep_log.severity = FATAL;
		...
		memcpy(new_resp, orig_resp, sizeof(GET_PROB_REC_L2_RESP_T));
		...
		{
			#ifdef DEBUG
				userlog("GET_PROB_REC_L2 : Error in get_time_version_rec() function");
			#endif
			//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
			*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
  ...
  else if(enqtype == 'A')
  {
	...
	{
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : malloc failed for enqtype=A ");
	#endif

		/* Log the error */
		strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Memory allocation failed for enqtype = A");
		sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : Allocation of memory failed for enqtype = A :");
		excep_log.termination_flag = 'Y';
		excep_log.severity = FATAL;
		...
		{
			#ifdef DEBUG
				userlog("GET_PROB_REC_L2 : Error in get_addr_info_rec() function");
			#endif
			//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
			*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
		...
		#ifdef DEBUG			
			userlog("GET_PROB_REC_L2 : get_addr_info_rec (resp->header.application_id): %s",resp->header.application_id);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec (resp->addr_info_ind): %c",resp->addr_info_ind);
		#endif
...
:b1 and FEETYPE in ('CF','FF','UF'))";
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	 ...
	 if(fee_cnt > 0)
	 {
	  ...
	  {
	   #ifdef DEBUG
		 userlog("GET_PROB_REC_L2 : malloc failed for enqtype=E ");
	   #endif

		/* Log the error */
		strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Memory allocation failed for enqtype = E");
		sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : Allocation of memory failed for enqtype = E :");
		excep_log.termination_flag = 'Y';
		excep_log.severity = FATAL;
		...
		{
			#ifdef DEBUG
				userlog("GET_PROB_REC_L2 : Error in get_appl_txn_rec() function");
			#endif
			//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
			*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
		...
		#ifdef DEBUG			
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec (resp->header.application_id): %s",resp->header.application_id);
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec (resp->appl_txn_cnt): %d",resp->appl_txn_cnt);
		#endif
...
PLID=:b1 and FEETYPE in ('CF','FF','UF'))";
   ...
   sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	 ...
	 if(fee_cnt > 0)
	 {
	  ...
	  {
	   #ifdef DEBUG
		 userlog("GET_PROB_REC_L2 : malloc failed for enqtype=E and OUTSTAND_TXN_FEE");
	   #endif

		/* Log the error */
		strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Memory allocation failed for enqtype = E and OUTSTAND_TXN_FEE");
		sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : Allocation of memory failed for enqtype = E and OUTSTAND_TXN_FEE");
		excep_log.termination_flag = 'Y';
		excep_log.severity = FATAL;
		...
		{
		 #ifdef DEBUG
				userlog("GET_PROB_REC_L2 : Error in get_outstand_txn_rec() function");
		 #endif
			//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
			*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
		...
		#ifdef DEBUG			
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec (resp->header.application_id): %s",resp->header.application_id);
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec (resp->outstand_txn_cnt): %d",resp->appl_txn_cnt);
		#endif
  ...
  { 
	// This code enqtype = P condition is added on 01/06/2016 for release 3.32 CR 293
	/*orig_resp = resp;
	resp_length = sizeof(GET_PROB_REC_L2_RESP_T);
	//resp_length = resp_length + (sizeof(ADDRESS_INFO_T) * 1);
	new_resp = (GET_PROB_REC_L2_RESP_T *) malloc( resp_length);
	...
	{
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : malloc failed for enqtype=P ");
	#endif
...

{
 ...
 and PROBLREASONCODE='Q0001')";
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		resp->missed_opex_ind = genkpt; // either P or U
		...
		#ifdef DEBUG			
			userlog("GET_PROB_REC_L2 : payment indicator(resp->header.application_id): %s",resp->header.application_id);
			userlog("GET_PROB_REC_L2 : genkpt value for enqtype=P, %c",genkpt);
			userlog("GET_PROB_REC_L2 : genkpt value for enqtype=P resp->missed_opex_ind, %c",resp->missed_opex_ind);
			userlog("GET_PROB_REC_L2 : genkpt value for enqtype=P resp->enqtype_ind, %c",resp->enqtype_ind);
		#endif
...

{
 ...
 and NVL(ENQTYPE,'Z')<>'M')";
  ...
  // NULL is not equal to M that is NVL is used here
	...
	if (new_resp == NULL)
	{
		...
		/* Log the error */
		strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Tuxedo memory allocation failed");
		sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : Allocation of memory failed : ");
		excep_log.termination_flag = 'Y';
		excep_log.severity = FATAL;
		...
		{
			#ifdef DEBUG
				userlog("GET_PROB_REC_L2 : Error in get_other_gsc_problem_recs() function");
			#endif
			//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
			*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
		...
		#ifdef DEBUG			
			userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs (resp->header.application_id): %s",resp->header.application_id);
			userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs (resp->other_gsc_problem_ind): %c",resp->other_gsc_problem_ind);
		#endif
		...
		{
			#ifdef DEBUG
				userlog("GET_PROB_REC_L2 : Error in get_prob_appl_details() function");
			#endif
			//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
			*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
		...
		#ifdef DEBUG
				userlog("GET_PROB_REC_L2 : get_prob_count (prob_count): %d",prob_count);
		#endif
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : ****Before attaching to resp buffer****");
	#endif

	orig_resp = resp;
	resp_length = (sizeof(GET_PROB_REC_L2_RESP_T) + sizeof(OTHER_GSC_PROBLEMS_T));
	...
	userlog("GET_PROB_REC_L2: Reallocation of response buffer Failed");
	#endif

	strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Service failed due to RESP_BUF_ERR at Reallocation");
	sprintf(excep_log.error_msg,"GET_PROB_REC_L2 :Service failed due to RESP_BUF_ERR at Reallocation");
	excep_log.termination_flag = 'Y';
	excep_log.severity = FATAL;
	log_error(ctx);
...
#ifdef DEBUG
	userlog("GET_PROB_REC_L2 : The address of resp buffer reallocated is 0x%X",resp);
#endif
	...
	{
		#ifdef DEBUG
			userlog("GET_PROB_REC_L2 : Error in get_appl_missed_opex_rec() function");
		#endif
		//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
				*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
	...
	#ifdef DEBUG			
			userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec (resp->missed_opex_ind): %c",resp->missed_opex_ind);
	#endif
	...
	if(ret_val != GMPC_GOOD)
		{
		#ifdef DEBUG
			userlog("GET_PROB_REC_L2 : Error in get_probl_record_recs() function");
		#endif
				//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
				*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
	...
	#ifdef DEBUG			
			userlog("GET_PROB_REC_L2 : get_probl_record_recs (resp->probl_record_cnt): %d",resp->probl_record_cnt);
	#endif
	...
	orig_other_gsc = (OTHER_GSC_PROBLEMS_T *)(temp_resp + 1);
		...
		userlog(" ");	
		userlog("GET_PROB_REC_L2 : response buffer (resp->header.application_id): %s",temp_resp->header.application_id);
		userlog("GET_PROB_REC_L2 : response buffer (resp->other_gsc_problem_ind): %c",temp_resp->other_gsc_problem_ind);
		userlog("GET_PROB_REC_L2 : response buffer (resp->header.application_id): %d",temp_resp->probl_record_cnt);
		userlog("GET_PROB_REC_L2 : response buffer (resp->other_gsc_problem_ind): %c",temp_resp->missed_opex_ind);

		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->applstat - %c", orig_other_gsc->applstat);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->kptno - %s", orig_other_gsc->kptno);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->collcenter - %s", orig_other_gsc->collcenter);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->cardcolldate - %s", orig_other_gsc->cardcolldate);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->idtype - %s", orig_other_gsc->idtype);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->idno - %s", orig_other_gsc->idno);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->userid - %s", orig_other_gsc->userid);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->contactno - %s", orig_other_gsc->contactno);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->sscbranchcode - %s", orig_other_gsc->sscbranchcode);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->qticketno - %ld", orig_other_gsc->qticketno);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->licidno - %s", orig_other_gsc->licidno);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->ownercat - %c", orig_other_gsc->ownercat);		
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->applremarks - %s", orig_other_gsc->applremarks);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->applpriority - %d", orig_other_gsc->applpriority);
		userlog("GET_PROB_REC_L2 : response buffer : other_gsc->timestamp - %s", orig_other_gsc->timestamp);
		userlog(" ");
	#endif
	...
	orig_missed_opex = (APPL_MISSED_OPEX_T *)(orig_other_gsc + 1);
		...
		userlog("");
		userlog("GET_PROB_REC_L2: response buffer :address1: %s",orig_missed_opex->address1);
		userlog("GET_PROB_REC_L2: response buffer :address2: %s",orig_missed_opex->address2);
		userlog("GET_PROB_REC_L2: response buffer :address3: %s",orig_missed_opex->address3);
		userlog("GET_PROB_REC_L2: response buffer :birthdate: %s",orig_missed_opex->birthdate);
		userlog("GET_PROB_REC_L2: response buffer :birthplacecode: %s",orig_missed_opex->birthplacecode);
		userlog("GET_PROB_REC_L2: response buffer :birthstatecode: %s",orig_missed_opex->birthstatecode);
		userlog("GET_PROB_REC_L2: response buffer :citizennationcode: %s",orig_missed_opex->citizennationcode);
		userlog("GET_PROB_REC_L2: response buffer :colourarticlecode: %s",orig_missed_opex->colourarticlecode);
		userlog("GET_PROB_REC_L2: response buffer :fatheridtype: %s",orig_missed_opex->fatheridtype);
		userlog("GET_PROB_REC_L2: response buffer :gender: %c",orig_missed_opex->gender);
		userlog("GET_PROB_REC_L2: response buffer :hkind: %c",orig_missed_opex->hkind);
		userlog("GET_PROB_REC_L2: response buffer :iccolorcode: %c",orig_missed_opex->iccolorcode);
		userlog("GET_PROB_REC_L2: response buffer :idtype: %s",orig_missed_opex->idtype);
		userlog("GET_PROB_REC_L2: response buffer :immexpirydate: %s",orig_missed_opex->immexpirydate);
		userlog("GET_PROB_REC_L2: response buffer :immrefdate: %s",orig_missed_opex->immrefdate);
		userlog("GET_PROB_REC_L2: response buffer :kppno: %s",orig_missed_opex->kppno);
		userlog("GET_PROB_REC_L2: response buffer :kptno: %s",orig_missed_opex->kptno);
		userlog("GET_PROB_REC_L2: response buffer :ktindcode: %s",orig_missed_opex->ktindcode);
		userlog("GET_PROB_REC_L2: response buffer :lastcardissuedate: %s",orig_missed_opex->lastcardissuedate);
		userlog("GET_PROB_REC_L2: response buffer :militaryid: %s",orig_missed_opex->militaryid);
		userlog("GET_PROB_REC_L2: response buffer :motheridtype: %s",orig_missed_opex->motheridtype);
		userlog("GET_PROB_REC_L2: response buffer :orignameind: %c",orig_missed_opex->orignameind);
		userlog("GET_PROB_REC_L2: response buffer :passportissuecountry: %s",orig_missed_opex->passportissuecountry);
		userlog("GET_PROB_REC_L2: response buffer :passportissuedate: %s",orig_missed_opex->passportissuedate);
		userlog("GET_PROB_REC_L2: response buffer :permitissuedate: %s",orig_missed_opex->permitissuedate);
		userlog("GET_PROB_REC_L2: response buffer :policeid: %s",orig_missed_opex->policeid);
		userlog("GET_PROB_REC_L2: response buffer :policeretiredate: %s",orig_missed_opex->policeretiredate);
		userlog("GET_PROB_REC_L2: response buffer :polmilitarycode: %c",orig_missed_opex->polmilitarycode);
		userlog("GET_PROB_REC_L2: response buffer :polmilitaryjoindate: %s",orig_missed_opex->polmilitaryjoindate);
		userlog("GET_PROB_REC_L2: response buffer :racecode: %s",orig_missed_opex->racecode);
		userlog("GET_PROB_REC_L2: response buffer :relationcode: %s",orig_missed_opex->relationcode);
		userlog("GET_PROB_REC_L2: response buffer :religioncode: %c",orig_missed_opex->religioncode);
		userlog("GET_PROB_REC_L2: response buffer :residentstat: %c",orig_missed_opex->residentstat);
		userlog("GET_PROB_REC_L2: response buffer :sponsoridtype: %s",orig_missed_opex->sponsoridtype);
		userlog("GET_PROB_REC_L2: response buffer :statecode: %s",orig_missed_opex->statecode);
		userlog("GET_PROB_REC_L2: response buffer :unknownbirthind: %c",orig_missed_opex->unknownbirthind);
		userlog("GET_PROB_REC_L2: response buffer :birthdistrictcode: %d",orig_missed_opex->birthdistrictcode);
		userlog("GET_PROB_REC_L2: response buffer :cardlostcnt: %d",orig_missed_opex->cardlostcnt);
		userlog("GET_PROB_REC_L2: response buffer :citycode: %d",orig_missed_opex->citycode);		
		userlog("GET_PROB_REC_L2: response buffer :currlongname: %s",orig_missed_opex->currlongname);
		userlog("GET_PROB_REC_L2: response buffer :currshortname1: %s",orig_missed_opex->currshortname1);
		userlog("GET_PROB_REC_L2: response buffer :currshortname2: %s",orig_missed_opex->currshortname2);
		userlog("GET_PROB_REC_L2: response buffer :fatheridno: %s",orig_missed_opex->fatheridno);
		userlog("GET_PROB_REC_L2: response buffer :gmpcshortname1: %s",orig_missed_opex->gmpcshortname1);
		userlog("GET_PROB_REC_L2: response buffer :gmpcshortname2: %s",orig_missed_opex->gmpcshortname2);
		userlog("GET_PROB_REC_L2: response buffer :gmpcshortname3: %s",orig_missed_opex->gmpcshortname3);
		userlog("GET_PROB_REC_L2: response buffer :idnumber: %s",orig_missed_opex->idnumber);
		userlog("GET_PROB_REC_L2: response buffer :immrefno: %s",orig_missed_opex->immrefno);
		userlog("GET_PROB_REC_L2: response buffer :motheridno: %s",orig_missed_opex->motheridno);
		userlog("GET_PROB_REC_L2: response buffer :origname: %s",orig_missed_opex->origname);
		userlog("GET_PROB_REC_L2: response buffer :passportno: %s",orig_missed_opex->passportno);
		userlog("GET_PROB_REC_L2: response buffer :permitno: %s",orig_missed_opex->permitno);
		userlog("GET_PROB_REC_L2: response buffer :postcode: %s",orig_missed_opex->postcode);
		userlog("GET_PROB_REC_L2: response buffer :sponsorcurrlongname: %s",orig_missed_opex->sponsorcurrlongname);
		userlog("GET_PROB_REC_L2: response buffer :sponsoridno: %s",orig_missed_opex->sponsoridno);
		userlog("GET_PROB_REC_L2: response buffer (resp->missed_opex_ind): %c",resp->missed_opex_ind);
	#endif
	...
	for(j=0;j<prob_count;j++,orig_prob_details++)
	{
			...
			userlog(" GET_PROB_REC_L2: response buffer : prob_no : %d", orig_prob_details->prob_no);
			userlog(" GET_PROB_REC_L2: response buffer : id_type : %s", orig_prob_details->id_type);
			userlog(" GET_PROB_REC_L2: response buffer : id_no : %s", orig_prob_details->id_no);
			userlog(" GET_PROB_REC_L2: response buffer : prob_date : %s", orig_prob_details->prob_date);
			userlog(" GET_PROB_REC_L2: response buffer : reason_code : %s", orig_prob_details->reason_code);
			userlog(" GET_PROB_REC_L2: response buffer : reason_srno : %d", orig_prob_details->reason_srno);
			userlog(" GET_PROB_REC_L2: response buffer : prob_stat : %c", orig_prob_details->prob_stat);
			userlog(" GET_PROB_REC_L2: response buffer : prob_remarks : %s", orig_prob_details->prob_remarks);
			userlog(" GET_PROB_REC_L2: response buffer : prob_solve_date : %s", orig_prob_details->prob_solve_date);
			userlog(" GET_PROB_REC_L2: response buffer : user_id : %s", orig_prob_details->user_id);
			userlog(" GET_PROB_REC_L2: response buffer : workstation_id : %s", orig_prob_details->workstation_id);
			userlog(" GET_PROB_REC_L2: response buffer : action_date : %s", orig_prob_details->action_date);
			userlog(" GET_PROB_REC_L2: response buffer : action_remarks : %s", orig_prob_details->action_remarks);
			userlog(" GET_PROB_REC_L2: response buffer : action_user_id : %s", orig_prob_details->action_user_id);
			userlog(" GET_PROB_REC_L2: response buffer : branch_code : %s", orig_prob_details->branch_code);
			userlog(" GET_PROB_REC_L2: response buffer : txn_code : %s", orig_prob_details->txn_code);
			userlog(" GET_PROB_REC_L2: response buffer : legacy_type : %s", orig_prob_details->legacy_type);
			userlog(" GET_PROB_REC_L2: response buffer : gscbupdflag : %c", orig_prob_details->gscbupdflag);
			userlog(" GET_PROB_REC_L2: response buffer : genkpt : %c", orig_prob_details->genkpt);
			userlog(" GET_PROB_REC_L2: response buffer : bskrecd : %c", orig_prob_details->bskrecd);
			userlog(" ");
			userlog("GET_PROB_REC_L2 : get_probl_record_recs (resp->probl_record_cnt): %d",resp->probl_record_cnt);
...
else if(strcmp(req->header.application_id,"\0") != 0)
{
		...
		//Added by Salmi on 11 Aug 2021 for My KAS Tamat Tempoh

		strcpy(old_appl_id, req->application_id);

		#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : appl_id : %s",req->header.application_id);
		userlog("GET_PROB_REC_L2 : old_appl_id : %s",old_appl_id);
		#endif
		txncnt = 0;
		/* EXEC SQL SELECT COUNT(*) INTO :txncnt
			FROM PROBL_RECORD
			WHERE APPLID = :old_appl_id; */ 
...
b1";
  ...
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)old_appl_id;
  sqlstm.sqhstl[1] = (unsigned int  )20;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)0;
  sqlstm.sqinds[1] = (         int  )0;
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
			#ifdef DEBUG
			userlog("GET_PROB_REC_L2 : No record from PROBL_RECORD : %s",SQLMSG);
			#endif
		}
		#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : txncnt : %d",txncnt);
		#endif
    ...
    if(txncnt > 0)
	{
		...
		orig_resp = resp;
		resp_length = sizeof(GET_PROB_REC_L2_RESP_T);
		resp_length = resp_length + (sizeof(PROB_DETAILS2_T) * txncnt);
		new_resp = (GET_PROB_REC_L2_RESP_T *) malloc( resp_length);
		...
		if (new_resp == NULL)
		{
			...
			/* Log the error */
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : Memory allocation failed for get_probl_record");
			sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : Allocation of memory failed for get_probl_record ");
			excep_log.termination_flag = 'Y';
			excep_log.severity = FATAL;
		...
		probl_record = (PROB_DETAILS2_T *)(resp + 1);

	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : The application_id before updating the ENQFLAG in PROBL_RECORD table to Y : %s",req->header.application_id);
	#endif
		ret_val = 0;
		ret_val = get_probl_record(req->application_id,probl_record,txncnt, ctx);
		if(ret_val != GMPC_GOOD)
		{
		#ifdef DEBUG
			userlog("GET_PROB_REC_L2 : Error in get_probl_record() function");
		#endif
		...
		resp->other_gsc_problem_ind = ' ';
		resp->probl_record_cnt = 0;
		resp->missed_opex_ind = ' ';
		resp->upd_flag = ' ';
		resp->addr_info_ind = ' ';
		resp->appl_txn_cnt = txncnt;
		resp->outstand_txn_cnt = 0;
		resp->enqtype_ind = ' ';

		//for testing
		//test_resp = resp;
		//fptr = fopen("d:\\ijpn\\log\\testresp.txt","wb");
		//fwrite(test_resp, 1,1000,fptr);
		//fclose(fptr);
		//Salmi add for test

		#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : Success get_probl_record !!");
		#endif
	}

	else
	{   
	//Added by Salmi on 11 Aug 2021 for My KAS Tamat Tempoh -End
...
/*
		...
		{
		#ifdef DEBUG
			userlog("GET_PROB_REC_L2 : Error in update_probl_record() function");
		#endif
		//tpreturn(TPSUCCESS, ret_val, (char *) resp, resp_length, 0);
				*pRespSize = resp_length;
			//memcpy(*pResp, resp, resp_length);
...
#ifdef DEBUG
	userlog("GET_PROB_REC_L2 : The ENQFLAG in PROBL_RECORD table is successfully updated to Y ");
#endif
		resp->upd_flag = 'Y';
	Remark by Salmi for Mykas Tamat Tempoh 12 AUg 2021	*/
	...
	strcpy(prog_log.remarks,"GET_PROB_REC_L2 : The serivce completed successfully");
	log_exit(ctx);

	#ifdef DEBUG		
		userlog("GET_PROB_REC_L2 : The serivce completed successfully");
	#endif		

	//tpreturn(TPSUCCESS, GMPC_GOOD, (char *) resp, resp_length, 0);
		userlog("GET_PROB_REC_L2 : Response buffer size %d ", resp_length);
		*pRespSize = resp_length;
		userlog("GET_PROB_REC_L2 : After swap buffer size %d ", resp_length);
		//memcpy(*pResp, resp, resp_length);
		*pResp  = resp;
		
		userlog("GET_PROB_REC_L2 : After swap Memory size %d ", resp_length);
...
#ifdef DEBUG
	userlog("GET_PROB_REC_L2 : in check_id_type() function");
	userlog("GET_PROB_REC_L2 : the input ID type is %d",atoi(id_type));
#endif
...
// Modification for IJPN
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : sbranchcode - %s", sbranchcode);
	#endif

	strcpy(branchcode, sbranchcode);

	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : branchcode - %s", branchcode);
	#endif
	...
	/* EXEC SQL SELECT APPLID INTO :appl_id
			...
			WHERE SSCBRANCHCODE = :branchcode
			AND   SENDFLAG = 'N'
			AND NVL(ENQTYPE,'Z') != 'M'    // Added this on 21/12/2009 for myexpress
			AND   ROWNUM = 1; */ 

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select APPLID into :b0  from APPNT_PROBL_DATA where (((SSCBR\
ANCHCODE=:b1 and SENDFLAG='N') and NVL(ENQTYPE,'Z')<>'M') and ROWNUM=1)";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	  ...
	  if((SQLCODE) && !(NO_DATA_FOUND))
		{
		 #ifdef DEBUG
			userlog(" GET_PROB_REC_L2 : get_other_gsc_problem_recs : Selecting appl_id from APPNT_PROBL_DATA failed : %s", SQLMSG);
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_other_gsc_problem_recs: Selecting appl_id from APPNT_PROBL_DATA failed");
			sprintf(excep_log.error_msg, "GET_PROB_REC_L2 : get_other_gsc_problem_recs: Selecting appl_id from APPNT_PROBL_DATA failed : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
		...
		{
			#ifdef DEBUG
				userlog(" GET_PROB_REC_L2 : get_other_gsc_problem_recs : NO DATA FOUND in APPNT_PROBL_DATA table : %s", SQLMSG);
			#endif			
			*other_gsc_flag = 1;
			return GMPC_GOOD;
		}
	...
	/* EXEC SQL SELECT APPLID,APPLSTAT,KPTNO,COLLCENTER,TO_CHAR(CARDCOLLDATE,'DDMMYYYY'),
			...
			APPLPRIORITY,TO_CHAR(TIMESTAMP,'DDMMYYYY'),LEGAPPLID
		INTO
			...
			:timestamp:timestamp_ind,:lapplid:lapplid_ind
		FROM
			 APPLICATION 
		WHERE (APPLID = :appl_id)		
...
( timestamp ,'DDMMYYYY') ,LEGAPPLID into :b0,:b1,:b2:b3,:b4:b5,:b6:b7,:b8:b9,:\
b10:b11,:b12:b13,:b14:b15,:b16:b17,:b18:b19,:b20:b21,:b22:b23,:b24:b25,:b26,:b\
27:b28,:b29:b30  from APPLICATION where (APPLID=:b0 and APPLSTAT in ('X','Q','\
T','H'))";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
		 #ifdef DEBUG
			userlog(" GET_PROB_REC_L2 : get_other_gsc_problem_recs : Selecting other gsc problem records from APPLICATION & PROBL_RECORD failed : %s", SQLMSG);
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_other_gsc_problem_recs: Selecting other gsc problem records failed from APPLICATION & PROBL_RECORD");
			sprintf(excep_log.error_msg, "GET_PROB_REC_L2 : get_other_gsc_problem_recs: Selecting other gsc problem records failed from APPLICATION & PROBL_RECORD : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
		...
		{
			#ifdef DEBUG
				userlog(" GET_PROB_REC_L2 : get_other_gsc_problem_recs : NO DATA FOUND in APPL_MISSED_OPEX table for given APPLID : %s", SQLMSG);
			#endif
			/* EXEC SQL UPDATE APPNT_PROBL_DATA 
					SET SENDFLAG = 'Y'
					WHERE APPLID = :appl_id
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "update APPNT_PROBL_DATA  set SENDFLAG='Y' where (APPLID=:b\
0 and NVL(ENQTYPE,'Z')<>'M')";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
			...
			{
			#ifdef DEBUG
			userlog(" GET_PROB_REC_L2 : get_other_gsc_problem_recs : Updating SENDFLAG in APPNT_PROBL_DATA failed : %s", SQLMSG);
			#endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_other_gsc_problem_recs: Updating SENDFLAG in APPNT_PROBL_DATA failed");
			sprintf(excep_log.error_msg, "GET_PROB_REC_L2 : get_other_gsc_problem_recs: Updating SENDFLAG in APPNT_PROBL_DATA failed : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
	...
	#ifdef DEBUG
		userlog(" ");
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : appl_id - %s", appl_id);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : applstat - %c", applstat);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : kptno - %s", kptno);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : collcenter - %s", collcenter);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : cardcolldate - %s", cardcolldate);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : idtype - %s", idtype);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : idno - %s", idno.arr);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : userid - %s", userid);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : contactno - %s", contactno.arr);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : sscbranchcode - %s", sscbranchcode);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : qticketno - %ld", qticketno);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : licidno - %s", licidno.arr);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : ownercat - %c", ownercat);		
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : applremarks - %s", applremarks.arr);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : applpriority - %d", applpriority);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : timestamp - %s", timestamp);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : lapplid - %s", lapplid);
		userlog(" ");
	#endif
	...
	#ifdef DEBUG			
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : lappl_id - %s", lappl_id);	
	#endif
	...
	#ifdef DEBUG
		userlog(" ");		
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->applstat - %c", other_gsc->applstat);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->kptno - %s", other_gsc->kptno);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->collcenter - %s", other_gsc->collcenter);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->cardcolldate - %s", other_gsc->cardcolldate);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->idtype - %s", other_gsc->idtype);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->idno - %s", other_gsc->idno);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->userid - %s", other_gsc->userid);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->contactno - %s", other_gsc->contactno);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->sscbranchcode - %s", other_gsc->sscbranchcode);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->qticketno - %ld", other_gsc->qticketno);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->licidno - %s", other_gsc->licidno);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->ownercat - %c", other_gsc->ownercat);		
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->applremarks - %s", other_gsc->applremarks);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->applpriority - %d", other_gsc->applpriority);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->timestamp - %s", other_gsc->timestamp);
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : other_gsc->legapplid - %s", other_gsc->legapplid);
		userlog(" ");
	#endif

		
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_other_gsc_problem_recs : Record selected successfully");
	#endif
...
// Modification for IJPN
	...
	#ifdef DEBUG			
			userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec :lappl_id): %s",lappl_id);
			userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec :hv_applid): %s",hv_applid);
	#endif
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	...
	else if(NO_DATA_FOUND)
	{
		...
		*missed_opex_flag = 1;
		...
		userlog(" ");
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_applid - %s", hv_applid);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_address1 - %s", hv_address1.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_address2 - %s", hv_address2.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_address3 - %s", hv_address3.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_birthdate - %s", hv_birthdate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_birthdistrictcode - %d", hv_birthdistrictcode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_birthplacecode - %s", hv_birthplacecode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_cardlostcnt - %d", hv_cardlostcnt);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_citizennationcode - %s", hv_citizennationcode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_citycode - %d", hv_citycode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_colourarticlecode - %s", hv_colourarticlecode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_currlongname - %s", hv_currlongname.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_currlongname1 - %s", hv_currshortname1.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_currlongname2 - %s", hv_currshortname2.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_fatheridno - %s", hv_fatheridno.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_fatheridtype - %s", hv_fatheridtype);		
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_gender - %c", hv_gender);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_gmpcshortname1 - %s", hv_gmpcshortname1.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_gmpcshortname2 - %s", hv_gmpcshortname2.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_gmpcshortname3 - %s", hv_gmpcshortname2.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_hkind - %c", hv_hkind);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_iccolorcode - %c", hv_iccolorcode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_idnumber - %s", hv_idnumber.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_idtype - %s", hv_idtype);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_immexpirydate - %s", hv_immexpirydate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_immrefno - %s", hv_immrefno.arr);		
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_kppno - %s", hv_kppno);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_kptno - %s", hv_kptno);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_ktindcode - %s", hv_ktindcode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_lastcardissuedate - %s", hv_lastcardissuedate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_militaryid - %s", hv_militaryid);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_motheridno - %s", hv_motheridno.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_motheridtype - %s", hv_motheridtype);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_origname - %s", hv_origname.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_orignameind - %c", hv_orignameind);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_passportissuecountry - %s", hv_passportissuecountry);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_passportissuedate - %s", hv_passportissuedate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_passportno - %s", hv_passportno.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_permitissuedate - %s", hv_permitissuedate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_permitno - %s", hv_permitno.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_policeid - %s", hv_policeid);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_policeretiredate - %s", hv_policeretiredate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_polmilitarycode - %c", hv_polmilitarycode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_polmilitaryjoindate - %s", hv_polmilitaryjoindate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_postcode - %s", hv_postcode.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_racecode - %s", hv_racecode);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_ktstartdate - %s", hv_ktstartdate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_ktenddate - %s", hv_ktenddate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_ptissuedate - %s", hv_ptissuedate);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_birthregndate - %s", hv_birthregndate);
	#endif
	...
	if(hv_immrefno_ind == 0)
	{
		...
		userlog("----------> TESTING <----------");
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : hv_immrefno - %s", hv_immrefno.arr);
		userlog("GET_PROB_REC_L2 : get_appl_missed_opex_rec : missed_opex_rec->immrefno - %s", missed_opex_rec->immrefno);
		userlog("----------> TESTING <----------");
		#endif
	}
	...
	if(hv_birthregndate_ind == 0)
	{
		...
		userlog("");
		userlog("GET_PROB_REC_L2: address1: %s",missed_opex_rec->address1);
		userlog("GET_PROB_REC_L2: address2: %s",missed_opex_rec->address2);
		userlog("GET_PROB_REC_L2: address3: %s",missed_opex_rec->address3);
		userlog("GET_PROB_REC_L2: birthdate: %s",missed_opex_rec->birthdate);
		userlog("GET_PROB_REC_L2: birthplacecode: %s",missed_opex_rec->birthplacecode);
		userlog("GET_PROB_REC_L2: birthstatecode: %s",missed_opex_rec->birthstatecode);
		userlog("GET_PROB_REC_L2: citizennationcode: %s",missed_opex_rec->citizennationcode);
		userlog("GET_PROB_REC_L2: colourarticlecode: %s",missed_opex_rec->colourarticlecode);
		userlog("GET_PROB_REC_L2: fatheridtype: %s",missed_opex_rec->fatheridtype);
		userlog("GET_PROB_REC_L2: gender: %c",missed_opex_rec->gender);
		userlog("GET_PROB_REC_L2: hkind: %c",missed_opex_rec->hkind);
		userlog("GET_PROB_REC_L2: iccolorcode: %c",missed_opex_rec->iccolorcode);
		userlog("GET_PROB_REC_L2: idtype: %s",missed_opex_rec->idtype);
		userlog("GET_PROB_REC_L2: immexpirydate: %s",missed_opex_rec->immexpirydate);
		userlog("GET_PROB_REC_L2: immrefdate: %s",missed_opex_rec->immrefdate);
		userlog("GET_PROB_REC_L2: kppno: %s",missed_opex_rec->kppno);
		userlog("GET_PROB_REC_L2: kptno: %s",missed_opex_rec->kptno);
		userlog("GET_PROB_REC_L2: ktindcode: %s",missed_opex_rec->ktindcode);
		userlog("GET_PROB_REC_L2: lastcardissuedate: %s",missed_opex_rec->lastcardissuedate);
		userlog("GET_PROB_REC_L2: militaryid: %s",missed_opex_rec->militaryid);
		userlog("GET_PROB_REC_L2: motheridtype: %s",missed_opex_rec->motheridtype);
		userlog("GET_PROB_REC_L2: orignameind: %c",missed_opex_rec->orignameind);
		userlog("GET_PROB_REC_L2: passportissuecountry: %s",missed_opex_rec->passportissuecountry);
		userlog("GET_PROB_REC_L2: passportissuedate: %s",missed_opex_rec->passportissuedate);
		userlog("GET_PROB_REC_L2: permitissuedate: %s",missed_opex_rec->permitissuedate);
		userlog("GET_PROB_REC_L2: policeid: %s",missed_opex_rec->policeid);
		userlog("GET_PROB_REC_L2: policeretiredate: %s",missed_opex_rec->policeretiredate);
		userlog("GET_PROB_REC_L2: polmilitarycode: %c",missed_opex_rec->polmilitarycode);
		userlog("GET_PROB_REC_L2: polmilitaryjoindate: %s",missed_opex_rec->polmilitaryjoindate);
		userlog("GET_PROB_REC_L2: racecode: %s",missed_opex_rec-> racecode);
		userlog("GET_PROB_REC_L2: relationcode: %s",missed_opex_rec->relationcode);
		userlog("GET_PROB_REC_L2: religioncode: %c",missed_opex_rec->religioncode);
		userlog("GET_PROB_REC_L2: residentstat: %c",missed_opex_rec->residentstat);
		userlog("GET_PROB_REC_L2: sponsoridtype: %s",missed_opex_rec->sponsoridtype);
		userlog("GET_PROB_REC_L2: statecode: %s",missed_opex_rec->statecode);
		userlog("GET_PROB_REC_L2: unknownbirthind: %c",missed_opex_rec->unknownbirthind);
		userlog("GET_PROB_REC_L2: birthdistrictcode: %d",missed_opex_rec->birthdistrictcode);
		userlog("GET_PROB_REC_L2: cardlostcnt: %d",missed_opex_rec->cardlostcnt);
		userlog("GET_PROB_REC_L2: citycode: %d",missed_opex_rec->citycode);		
		userlog("GET_PROB_REC_L2: currlongname: %s",missed_opex_rec->currlongname);
		userlog("GET_PROB_REC_L2: currshortname1: %s",missed_opex_rec->currshortname1);
		userlog("GET_PROB_REC_L2: currshortname2: %s",missed_opex_rec->currshortname2);
		userlog("GET_PROB_REC_L2: fatheridno: %s",missed_opex_rec->fatheridno);
		userlog("GET_PROB_REC_L2: gmpcshortname1: %s",missed_opex_rec->gmpcshortname1);
		userlog("GET_PROB_REC_L2: gmpcshortname2: %s",missed_opex_rec->gmpcshortname2);
		userlog("GET_PROB_REC_L2: gmpcshortname3: %s",missed_opex_rec->gmpcshortname3);
		userlog("GET_PROB_REC_L2: idnumber: %s",missed_opex_rec->idnumber);
		userlog("GET_PROB_REC_L2: immrefno: %s",missed_opex_rec->immrefno);
		userlog("GET_PROB_REC_L2: motheridno: %s",missed_opex_rec->motheridno);
		userlog("GET_PROB_REC_L2: origname: %s",missed_opex_rec->origname);
		userlog("GET_PROB_REC_L2: passportno: %s",missed_opex_rec->passportno);
		userlog("GET_PROB_REC_L2: permitno: %s",missed_opex_rec->permitno);
		userlog("GET_PROB_REC_L2: postcode: %s",missed_opex_rec->postcode);
		userlog("GET_PROB_REC_L2: sponsorcurrlongname: %s",missed_opex_rec->sponsorcurrlongname);
		userlog("GET_PROB_REC_L2: sponsoridno: %s",missed_opex_rec->sponsoridno);
		userlog(" ");
	#endif
...
/********************************************************************************/
/* Function name: get_prob_rec_L2ord_recs												*/
...
#ifdef DEBUG
	userlog(" get_prob_rec_L2ord_recs : In get_prob_rec_L2ord_recs() function");
	userlog(" get_prob_rec_L2ord_recs : lappl_id - %s", lappl_id);
#endif
...

{
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	...
	{
	#ifdef DEBUG
		userlog(" get_prob_rec_L2ord_recs : Error in opening the cursor prob_details : %s", SQLMSG);
	#endif
		/* Log the error */
		strcpy(prog_log.remarks,"get_prob_rec_L2ord_recs : Error in opening the cursor prob_details");
		sprintf(excep_log.error_msg,"get_prob_rec_L2ord_recs : Error in opening the cursor prob_details : %s", SQLMSG);
		excep_log.termination_flag = 'Y';
		excep_log.severity = FATAL;
...

{
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
		#ifdef DEBUG
			userlog(" get_prob_rec_L2ord_recs : Error in fetching the cursor prob_details : %s", SQLMSG);
		#endif
			/* Log the error */
			strcpy(prog_log.remarks,"get_prob_rec_L2ord_recs : Error in fetching the cursor prob_details");
			sprintf(excep_log.error_msg,"get_prob_rec_L2ord_recs : Error in fetching the cursor prob_details : %s", SQLMSG);
			excep_log.termination_flag = 'Y';
			excep_log.severity = FATAL;
...

{
   ...
   sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
...
#ifdef DEBUG
		userlog(" ");
		userlog("GET_PROB_REC_L2 : get_prob_rec_L2ord_recs : local_prob_details.prob_no - %d", local_prob_details.prob_no);
		userlog("GET_PROB_REC_L2 : get_prob_rec_L2ord_recs : local_prob_details.id_type - %s", local_prob_details.id_type.arr);
		userlog("GET_PROB_REC_L2 : get_prob_rec_L2ord_recs : local_prob_details.id_no - %s", local_prob_details.id_no.arr);
		userlog("GET_PROB_REC_L2 : get_prob_rec_L2ord_recs : local_prob_details.prob_date - %s", local_prob_details.prob_date.arr);
		userlog("GET_PROB_REC_L2 : get_prob_rec_L2ord_recs : local_prob_details.reason_code - %s", local_prob_details.reason_code);
		userlog("GET_PROB_REC_L2 : get_prob_rec_L2ord_recs : local_prob_details.reason_srno - %d", local_prob_details.reason_srno);
		userlog("GET_PROB_REC_L2 : get_prob_rec_L2ord_recs : local_prob_details.prob_stat - %c", local_prob_details.prob_stat);
		userlog(" ");
#endif
		...
		#ifdef DEBUG
			userlog(" ");
			userlog(" get_prob_rec_L2ord_recs : prob_no : %d", prob_details->prob_no);
			userlog(" get_prob_rec_L2ord_recs : id_type : %s", prob_details->id_type);
			userlog(" get_prob_rec_L2ord_recs : id_no : %s", prob_details->id_no);
			userlog(" get_prob_rec_L2ord_recs : prob_date : %s", prob_details->prob_date);
			userlog(" get_prob_rec_L2ord_recs : reason_code : %s", prob_details->reason_code);
			userlog(" get_prob_rec_L2ord_recs : reason_srno : %d", prob_details->reason_srno);
			userlog(" get_prob_rec_L2ord_recs : prob_stat : %c", prob_details->prob_stat);
			userlog(" get_prob_rec_L2ord_recs : prob_remarks : %s", prob_details->prob_remarks);
			userlog(" get_prob_rec_L2ord_recs : prob_solve_date : %s", prob_details->prob_solve_date);
			userlog(" get_prob_rec_L2ord_recs : user_id : %s", prob_details->user_id);
			userlog(" get_prob_rec_L2ord_recs : workstation_id : %s", prob_details->workstation_id);
			userlog(" get_prob_rec_L2ord_recs : action_date : %s", prob_details->action_date);
			userlog(" get_prob_rec_L2ord_recs : action_remarks : %s", prob_details->action_remarks);
			userlog(" get_prob_rec_L2ord_recs : action_user_id : %s", prob_details->action_user_id);
			userlog(" get_prob_rec_L2ord_recs : branch_code : %s", prob_details->branch_code);
			userlog(" get_prob_rec_L2ord_recs : txn_code : %s", prob_details->txn_code);
			userlog(" get_prob_rec_L2ord_recs : legacy_type : %s", prob_details->legacy_type);
			userlog(" get_prob_rec_L2ord_recs : gscbupdflag : %c", prob_details->gscbupdflag);
			userlog(" get_prob_rec_L2ord_recs : genkpt : %c", prob_details->genkpt);
			userlog(" get_prob_rec_L2ord_recs : bskrecd : %c", prob_details->bskrecd);
			userlog(" ");
		#endif
...
#ifdef DEBUG
	userlog(" get_prob_rec_L2ord_recs : The problem details copied successfully to the response buffer \n");
#endif
...

{
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	...
	{
	#ifdef DEBUG
		userlog(" GET_PROB_REC_L2 :update_probl_record : Error in updating ENQFLAG of prob_details : %s", SQLMSG);
	#endif
	/* Log the error */
	strcpy(prog_log.remarks,"GET_PROB_REC_L2 :update_probl_record : Error in updating ENQFLAG of prob_details ");
	sprintf(excep_log.error_msg,"GET_PROB_REC_L2 :update_probl_record : Error in updating ENQFLAG of prob_details : %s", SQLMSG);
	excep_log.termination_flag = 'Y';
	excep_log.severity = FATAL;
	log_error(ctx);
	return UPDATE_ERROR;
	...
	#ifdef DEBUG
		userlog(" GET_PROB_REC_L2 : update_probl_record : Updated the ENQFLAG in PROBL_RECORD to Y successfully");
	#endif
...
and NVL(ENQTYPE,'Z')<>'M')";
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	...
	{
	#ifdef DEBUG
		userlog(" GET_PROB_REC_L2 :update_probl_record : Error while updating SENDFLAG of APPNT_PROBL_DATA : %s", SQLMSG);
	#endif
	/* Log the error */
	strcpy(prog_log.remarks,"GET_PROB_REC_L2 :update_probl_record : Error while updating SENDFLAG of APPNT_PROBL_DATA ");
	sprintf(excep_log.error_msg,"GET_PROB_REC_L2 :update_probl_record : Error while updating SENDFLAG of APPNT_PROBL_DATA : %s", SQLMSG);
	excep_log.termination_flag = 'Y';
	excep_log.severity = FATAL;
	log_error(ctx);
	return UPDATE_ERROR;
...
// Modification for IJPN
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_addr_info_rec : appl_id : %s",appl_id);
	#endif
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_addr_info_rec : applid : %s",applid.arr);
	#endif
...
e APPLID=:b18";
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
		 #ifdef DEBUG
			userlog(" GET_PROB_REC_L2 : get_addr_info_rec : Select from APPNT_JPN_INFO failed : %s", SQLMSG);
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_addr_info_rec : Select from APPNT_JPN_INFO failed");
			sprintf(excep_log.error_msg, "GET_PROB_REC_L2 : get_addr_info_rec : Select from APPNT_JPN_INFO failed : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
		...
		{
			#ifdef DEBUG
				userlog(" GET_PROB_REC_L2 : get_addr_info_rec : NO DATA FOUND in APPNT_JPN_INFO table : %s", SQLMSG);
			#endif			
			*addr_info_flag = 1;
			return GMPC_GOOD;
		}
		...
		#ifdef DEBUG
			userlog(" ");
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : shortname1 - %s", shortname1.arr);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : shortname2 - %s", shortname2.arr);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : shortname3 - %s", shortname3.arr);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : address1 - %s", address1.arr);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : address2 - %s", address2.arr);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : address3 - %s", address3.arr);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : statecode - %s", statecode.arr);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : postcode - %s", postcode.arr);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : citycode - %d", citycode);			
		#endif
...
D=:b2";
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
		 #ifdef DEBUG
			userlog(" GET_PROB_REC_L2 : get_addr_info_rec : Select from APPLICATION failed : %s", SQLMSG);
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_addr_info_rec : Select from APPLICATION failed");
			sprintf(excep_log.error_msg, "GET_PROB_REC_L2 : get_addr_info_rec : Select from APPLICATION failed : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
		...
		setnull(collcenter);
		 ...
		 #ifdef DEBUG
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : collcenter : %s", collcenter.arr);
			userlog(" ");
		 #endif
		...
		#ifdef DEBUG
			userlog(" ");
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->gmpcshortname1 - %s", addr_info->gmpcshortname1);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->gmpcshortname2 - %s", addr_info->gmpcshortname2);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->gmpcshortname3 - %s", addr_info->gmpcshortname3);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->address1 - %s", addr_info->address1);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->address2 - %s", addr_info->address2);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->address3 - %s", addr_info->address3);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->statecode - %s", addr_info->statecode);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->postcode - %s", addr_info->postcode);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->citycode - %d", addr_info->citycode);
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : addr_info->collcenter : %s", addr_info->collcenter);
			userlog(" ");
		#endif
		...
		*addr_info_flag = 0; // record found 
		...
		#ifdef DEBUG
			userlog("GET_PROB_REC_L2 : get_addr_info_rec : Record selected successfully");
		#endif
...
// Modification for IJPN
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_appl_txn_rec : appl_id : %s",appl_id);
	#endif
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_appl_txn_rec : applid : %s",applid.arr);
	#endif
...

{
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
		 #ifdef DEBUG
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec : open fee_cur failed ");
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_appl_txn_rec : open fee_cur failed");
			sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : get_appl_txn_rec : open fee_cur failed:%s ",SQLMSG);
			excep_log.termination_flag = 'Y';
			excep_log.severity = FATAL;
...

{
   ...
   sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
			...
			{
				#ifdef DEBUG
					userlog("GET_PROB_REC_L2 : get_appl_txn_rec : fee_cur failed while SELECT from appl_txn_fee :%s",SQLMSG);
				#endif
				strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_appl_txn_rec : fee_cur failed while SELECT from appl_txn_fee");
				sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : get_appl_txn_rec : fee_cur failed while SELECT from appl_txn_fee:%s ",SQLMSG);
				excep_log.termination_flag = 'Y';
				excep_log.severity = FATAL;
				log_error(ctx);
...

{
    ...
    sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		#ifdef DEBUG
			userlog(" ");
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec :  ltxnserno - %d", ltxnserno);
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec :  lfeetype - %s", lfeetype);
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec :  lfeeamt - %f", lfeeamt);
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec :  lagencyrevncode - %d", lagencyrevncode);					
		#endif
		...
		#ifdef DEBUG
			userlog(" ");
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec :  appl_txn->txnserno - %d", appl_txn->txnserno);
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec :  appl_txn->feetype - %s", appl_txn->feetype);
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec :  appl_txn->feeamt - %f", appl_txn->feeamt);
			userlog("GET_PROB_REC_L2 : get_appl_txn_rec :  appl_txn->agencyrevncode - %d", appl_txn->agencyrevncode);					
		#endif
...
// Modification for IJPN
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_outstand_txn_rec : appl_id : %s",appl_id);
	#endif
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_outstand_txn_rec : applid : %s",applid.arr);
	#endif
...

{
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
		 #ifdef DEBUG
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec : open fee_cur1 failed ");
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_outstand_txn_rec : open fee_cur1 failed");
			sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : get_outstand_txn_rec : open fee_cur1 failed:%s ",SQLMSG);
			excep_log.termination_flag = 'Y';
			excep_log.severity = FATAL;
...

{
   ...
   sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
			...
			{
				#ifdef DEBUG
					userlog("GET_PROB_REC_L2 : get_outstand_txn_rec : fee_cur1 failed while SELECT from appl_txn_fee :%s",SQLMSG);
				#endif
				strcpy(prog_log.remarks,"GET_PROB_REC_L2 : get_outstand_txn_rec : fee_cur1 failed while SELECT from appl_txn_fee");
				sprintf(excep_log.error_msg,"GET_PROB_REC_L2 : get_outstand_txn_rec : fee_cur1 failed while SELECT from appl_txn_fee:%s ",SQLMSG);
				excep_log.termination_flag = 'Y';
				excep_log.severity = FATAL;
				log_error(ctx);
...

{
    ...
    sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		#ifdef DEBUG
			userlog(" ");
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  ltxnserno - %d", ltxnserno);
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  lfeetype - %s", lfeetype);
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  lfeeamt - %f", lfeeamt);
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  lagencyrevncode - %d", lagencyrevncode);
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  lsend_gsc - %c", lsend_gsc);
		#endif
		...
		#ifdef DEBUG
			userlog(" ");
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  outstand_txn->txnserno - %d", outstand_txn->txnserno);
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  outstand_txn->feetype - %s", outstand_txn->feetype);
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  outstand_txn->feeamt - %f", outstand_txn->feeamt);
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  outstand_txn->agencyrevncode - %d", outstand_txn->agencyrevncode);					
			userlog("GET_PROB_REC_L2 : get_outstand_txn_rec :  outstand_txn->send_gsc - %c", outstand_txn->send_gsc);
		#endif
...
// Modification for IJPN
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_time_ver_rec : appl_id : %s",appl_id);
	#endif
	...
	#ifdef DEBUG
		userlog("GET_PROB_REC_L2 : get_time_ver_rec : applid : %s",applid.arr);
	#endif
...
from APPLICATION where APPLID=:b2";
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	...
	if((SQLCODE) && !(NO_DATA_FOUND))
		{
		 #ifdef DEBUG
			userlog(" GET_PROB_REC_L2 : get_time_ver_rec : Select from APPLICATION failed : %s", SQLMSG);
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 :  get_time_ver_rec: Select from APPLICATION failed");
			sprintf(excep_log.error_msg, "GET_PROB_REC_L2 :  get_time_ver_rec : Select from APPLICATION failed : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
...
RD_STATUS where APPLID=:b3";
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	...
	if((SQLCODE) && !(NO_DATA_FOUND))
		{
		 #ifdef DEBUG
			userlog(" GET_PROB_REC_L2 : get_time_ver_rec : Select from CARD_STATUS failed : %s", SQLMSG);
		 #endif
			strcpy(prog_log.remarks,"GET_PROB_REC_L2 :  get_time_ver_rec: Select from CARD_STATUS failed");
			sprintf(excep_log.error_msg, "GET_PROB_REC_L2 :  get_time_ver_rec : Select from CARD_STATUS failed : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
		...
		#ifdef DEBUG
			userlog(" ");
			userlog("GET_PROB_REC_L2 :  get_time_ver_rec :time stamp - %s", timeStatmp.arr);
			userlog("GET_PROB_REC_L2 : get_time_ver_rec : version - %d", version);
			userlog(" ");
		#endif
		...
		#ifdef DEBUG
			userlog(" ");
			userlog("GET_PROB_REC_L2 : get_time_ver_rec : time stamp - %s",time_version->timeStamp);
			userlog("GET_PROB_REC_L2 : get_time_ver_rec : version - %d",  time_version->cardVersion);
			userlog("GET_PROB_REC_L2 : get_time_ver_rec : agencyonchip - %s", lagencyonchip);
			userlog(" ");
		#endif
		...
		#ifdef DEBUG
			userlog("GET_PROB_REC_L2 : get_time_ver_rec : Record selected successfully");
		#endif
...
//Added by Salmi on 11 Aug 2021, MyKAS Tamat Tempoh
/********************************************************************************/
/* Function name: get_probl_record											    */
/* Description	: This function retrieves probl_record data for the given 	    */
/*                applicantion id												*/
/* Input		: Applicantion Id, pointer to PROB_DETAILS_T struct, Error Code */
/* Return values: GMPC_GOOD/ORA_ERROR											*/
/* Limitations	: None															*/
/********************************************************************************/

int get_probl_record(char *appl_id, PROB_DETAILS2_T *probl_record, int prob_cnt, void * ctx)
{
...
struct { unsigned short len; unsigned char arr[151]; } prob_remarks;
		...
		/* varchar prob_solve_date[DATE_TIME_SIZE]; */ 
struct { unsigned short len; unsigned char arr[16]; } prob_solve_date;
	
		char user_id[USER_ID_SIZE];				
		char workstation_id[WS_ID_SIZE];		
		/* varchar action_date[DATE_TIME_SIZE]; */ 
struct { unsigned short len; unsigned char arr[16]; } action_date;
...
struct { unsigned short len; unsigned char arr[151]; } action_remarks;
		...
		char txn_code[TRANSACTION_CODE_SIZE];	
		char legacy_type[AGENCY_TYPE_SIZE];	
		char probl_rec_applid[APP_ID_SIZE];
	}prob_rec;
	...
	sqlca.sqlcode = 0;
	/* EXEC SQL declare probl_record cursor for

		SELECT
					PROBLNO,
					IDTYPE,
					IDNO,
					TO_CHAR(PROBLDATE,'DDMMYYYY HH24MISS'),
					PROBLREASONCODE,	
					PROBLSERNO,
					PROBLSTAT,
					PROBLREMARKS,
					TO_CHAR(PROBLSOLVEDATE,'DDMMYYYY HH24MISS'),
					USERID,
					WSID,
					TO_CHAR(ACTDATETIME,'DDMMYYYY HH24MISS'),
					ACTREMARKS,
					ACTUSERID,
					BRANCHCODE,
					TXNCODE,
...

{
 ...
 sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	...
	{
		 #ifdef DEBUG
			userlog("get_probl_record : Select from PROBL_RECORD failed : %s", SQLMSG);
		 #endif
			strcpy(prog_log.remarks," get_probl_record: Select from PROBL_RECORD failed");
			sprintf(excep_log.error_msg, " get_probl_record : Select from PROBL_RECORD failed : %s", SQLMSG);
			excep_log.termination_flag = YES;
			excep_log.severity = FATAL;
			log_error(ctx);
	...
	for(i=0;i<cnt;i++)
	{
		...
		memset(&prob_rec,'\0',sizeof(prob_rec));
	  	memset(&prob_rec_ind,'\0',sizeof(prob_rec_ind));

		/* EXEC SQL FETCH probl_record
			INTO :prob_rec INDICATOR :prob_rec_ind; */ 

{
  ...
  sqlstm.sqfoff = (           int )0;
  sqlstm.sqfmod = (unsigned int )2;
  sqlstm.sqhstv[0] = (         void  *)&prob_rec.prob_no;
  sqlstm.sqhstl[0] = (unsigned int  )sizeof(int);
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         void  *)&prob_rec_ind.prob_no_ind;
  sqlstm.sqinds[0] = (         int  )0;
  sqlstm.sqharm[0] = (unsigned int  )0;
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (         void  *)prob_rec.id_type;
  sqlstm.sqhstl[1] = (unsigned int  )3;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         void  *)&prob_rec_ind.id_type_ind;
  sqlstm.sqinds[1] = (         int  )0;
  sqlstm.sqharm[1] = (unsigned int  )0;
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (         void  *)prob_rec.id_no;
  sqlstm.sqhstl[2] = (unsigned int  )16;
  sqlstm.sqhsts[2] = (         int  )0;
  sqlstm.sqindv[2] = (         void  *)&prob_rec_ind.id_no_ind;
  sqlstm.sqinds[2] = (         int  )0;
  sqlstm.sqharm[2] = (unsigned int  )0;
  sqlstm.sqadto[2] = (unsigned short )0;
  sqlstm.sqtdso[2] = (unsigned short )0;
  sqlstm.sqhstv[3] = (         void  *)&prob_rec.prob_date;
  sqlstm.sqhstl[3] = (unsigned int  )18;
  sqlstm.sqhsts[3] = (         int  )0;
  sqlstm.sqindv[3] = (         void  *)&prob_rec_ind.prob_date_ind;
  sqlstm.sqinds[3] = (         int  )0;
  sqlstm.sqharm[3] = (unsigned int  )0;
  sqlstm.sqadto[3] = (unsigned short )0;
  sqlstm.sqtdso[3] = (unsigned short )0;
  sqlstm.sqhstv[4] = (         void  *)prob_rec.reason_code;
  sqlstm.sqhstl[4] = (unsigned int  )6;
  sqlstm.sqhsts[4] = (         int  )0;
  sqlstm.sqindv[4] = (         void  *)&prob_rec_ind.reason_code_ind;
  sqlstm.sqinds[4] = (         int  )0;
  sqlstm.sqharm[4] = (unsigned int  )0;
  sqlstm.sqadto[4] = (unsigned short )0;
  sqlstm.sqtdso[4] = (unsigned short )0;
  sqlstm.sqhstv[5] = (         void  *)&prob_rec.reason_srno;
  sqlstm.sqhstl[5] = (unsigned int  )sizeof(int);
  sqlstm.sqhsts[5] = (         int  )0;
  sqlstm.sqindv[5] = (         void  *)&prob_rec_ind.reason_srno_ind;
  sqlstm.sqinds[5] = (         int  )0;
  sqlstm.sqharm[5] = (unsigned int  )0;
  sqlstm.sqadto[5] = (unsigned short )0;
  sqlstm.sqtdso[5] = (unsigned short )0;
  sqlstm.sqhstv[6] = (         void  *)&prob_rec.prob_stat;
  sqlstm.sqhstl[6] = (unsigned int  )1;
  sqlstm.sqhsts[6] = (         int  )0;
  sqlstm.sqindv[6] = (         void  *)&prob_rec_ind.prob_stat_ind;
  sqlstm.sqinds[6] = (         int  )0;
  sqlstm.sqharm[6] = (unsigned int  )0;
  sqlstm.sqadto[6] = (unsigned short )0;
  sqlstm.sqtdso[6] = (unsigned short )0;
  sqlstm.sqhstv[7] = (         void  *)&prob_rec.prob_remarks;
  sqlstm.sqhstl[7] = (unsigned int  )153;
  sqlstm.sqhsts[7] = (         int  )0;
  sqlstm.sqindv[7] = (         void  *)&prob_rec_ind.prob_remarks_ind;
  sqlstm.sqinds[7] = (         int  )0;
  sqlstm.sqharm[7] = (unsigned int  )0;
  sqlstm.sqadto[7] = (unsigned short )0;
  sqlstm.sqtdso[7] = (unsigned short )0;
  sqlstm.sqhstv[8] = (         void  *)&prob_rec.prob_solve_date;
  sqlstm.sqhstl[8] = (unsigned int  )18;
  sqlstm.sqhsts[8] = (         int  )0;
  sqlstm.sqindv[8] = (         void  *)&prob_rec_ind.prob_solve_date_ind;
  sqlstm.sqinds[8] = (         int  )0;
  sqlstm.sqharm[8] = (unsigned int  )0;
  sqlstm.sqadto[8] = (unsigned short )0;
  sqlstm.sqtdso[8] = (unsigned short )0;
  sqlstm.sqhstv[9] = (         void  *)prob_rec.user_id;
  sqlstm.sqhstl[9] = (unsigned int  )9;
  sqlstm.sqhsts[9] = (         int  )0;
  sqlstm.sqindv[9] = (         void  *)&prob_rec_ind.user_id_ind;
  sqlstm.sqinds[9] = (         int  )0;
  sqlstm.sqharm[9] = (unsigned int  )0;
  sqlstm.sqadto[9] = (unsigned short )0;
  sqlstm.sqtdso[9] = (unsigned short )0;
  sqlstm.sqhstv[10] = (         void  *)prob_rec.workstation_id;
  sqlstm.sqhstl[10] = (unsigned int  )16;
  sqlstm.sqhsts[10] = (         int  )0;
  sqlstm.sqindv[10] = (         void  *)&prob_rec_ind.workstation_id_ind;
  sqlstm.sqinds[10] = (         int  )0;
  sqlstm.sqharm[10] = (unsigned int  )0;
  sqlstm.sqadto[10] = (unsigned short )0;
  sqlstm.sqtdso[10] = (unsigned short )0;
  sqlstm.sqhstv[11] = (         void  *)&prob_rec.action_date;
  sqlstm.sqhstl[11] = (unsigned int  )18;
  sqlstm.sqhsts[11] = (         int  )0;
  sqlstm.sqindv[11] = (         void  *)&prob_rec_ind.action_date_ind;
  sqlstm.sqinds[11] = (         int  )0;
  sqlstm.sqharm[11] = (unsigned int  )0;
  sqlstm.sqadto[11] = (unsigned short )0;
  sqlstm.sqtdso[11] = (unsigned short )0;
  sqlstm.sqhstv[12] = (         void  *)&prob_rec.action_remarks;
  sqlstm.sqhstl[12] = (unsigned int  )153;
  sqlstm.sqhsts[12] = (         int  )0;
  sqlstm.sqindv[12] = (         void  *)&prob_rec_ind.action_remarks_ind;
  sqlstm.sqinds[12] = (         int  )0;
  sqlstm.sqharm[12] = (unsigned int  )0;
  sqlstm.sqadto[12] = (unsigned short )0;
  sqlstm.sqtdso[12] = (unsigned short )0;
  sqlstm.sqhstv[13] = (         void  *)prob_rec.action_user_id;
  sqlstm.sqhstl[13] = (unsigned int  )9;
  sqlstm.sqhsts[13] = (         int  )0;
  sqlstm.sqindv[13] = (         void  *)&prob_rec_ind.action_user_id_ind;
  sqlstm.sqinds[13] = (         int  )0;
  sqlstm.sqharm[13] = (unsigned int  )0;
  sqlstm.sqadto[13] = (unsigned short )0;
  sqlstm.sqtdso[13] = (unsigned short )0;
  sqlstm.sqhstv[14] = (         void  *)prob_rec.branch_code;
  sqlstm.sqhstl[14] = (unsigned int  )7;
  sqlstm.sqhsts[14] = (         int  )0;
  sqlstm.sqindv[14] = (         void  *)&prob_rec_ind.branch_code_ind;
  sqlstm.sqinds[14] = (         int  )0;
  sqlstm.sqharm[14] = (unsigned int  )0;
  sqlstm.sqadto[14] = (unsigned short )0;
  sqlstm.sqtdso[14] = (unsigned short )0;
  sqlstm.sqhstv[15] = (         void  *)prob_rec.txn_code;
  sqlstm.sqhstl[15] = (unsigned int  )4;
  sqlstm.sqhsts[15] = (         int  )0;
  sqlstm.sqindv[15] = (         void  *)&prob_rec_ind.txn_code_ind;
  sqlstm.sqinds[15] = (         int  )0;
  sqlstm.sqharm[15] = (unsigned int  )0;
  sqlstm.sqadto[15] = (unsigned short )0;
  sqlstm.sqtdso[15] = (unsigned short )0;
  sqlstm.sqhstv[16] = (         void  *)prob_rec.legacy_type;
  sqlstm.sqhstl[16] = (unsigned int  )4;
  sqlstm.sqhsts[16] = (         int  )0;
  sqlstm.sqindv[16] = (         void  *)&prob_rec_ind.legacy_type_ind;
  sqlstm.sqinds[16] = (         int  )0;
  sqlstm.sqharm[16] = (unsigned int  )0;
  sqlstm.sqadto[16] = (unsigned short )0;
  sqlstm.sqtdso[16] = (unsigned short )0;
  sqlstm.sqhstv[17] = (         void  *)prob_rec.probl_rec_applid;
  sqlstm.sqhstl[17] = (unsigned int  )20;
  sqlstm.sqhsts[17] = (         int  )0;
  sqlstm.sqindv[17] = (         void  *)&prob_rec_ind.probl_rec_applid_ind;
  sqlstm.sqinds[17] = (         int  )0;
  sqlstm.sqharm[17] = (unsigned int  )0;
  sqlstm.sqadto[17] = (unsigned short )0;
  sqlstm.sqtdso[17] = (unsigned short )0;
  ...
  sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
		...
		{
		#ifdef DEBUG
			userlog(" get_probl_record : Error in fetching the cursor probl_record : %s", SQLMSG);
		#endif
			/* Log the error */
			strcpy(prog_log.remarks,"get_probl_record  : Error in fetching the cursor probl_record");
			sprintf(excep_log.error_msg,"get_probl_record  : Error in fetching the cursor probl_record : %s", SQLMSG);
			excep_log.termination_flag = 'Y';
			excep_log.severity = FATAL;

			log_error(ctx);

			/* EXEC SQL CLOSE probl_record; */ 

{
   ...
   sqlcxt(&pcCtx, &sqlctx, &sqlstm, &sqlfpn);
	     ...
	     setlen(prob_rec.prob_date);	
	     setnull(prob_rec.prob_date);
		 setlen(prob_rec.prob_remarks);	
	     setnull(prob_rec.prob_remarks);
	 	 setlen(prob_rec.action_date);	
	     setnull(prob_rec.action_date);
		 setlen(prob_rec.action_remarks);	
	     setnull(prob_rec.action_remarks);   

		#ifdef DEBUG
		userlog(" prob_no          : %d",prob_rec.prob_no);
		userlog(" id_type          : %s",prob_rec.id_type);
        userlog(" id_no            : %s",prob_rec.id_no);
        userlog(" prob_date        : %s",prob_rec.prob_date.arr);
        userlog(" reason_code      : %s",prob_rec.reason_code);
        userlog(" reason_srno      : %d",prob_rec.reason_srno);
		userlog(" prob_stat        : %c",prob_rec.prob_stat);
		userlog(" prob_remarks     : %s",prob_rec.prob_remarks.arr);
        userlog(" prob_solve_date  : %s",prob_rec.prob_solve_date.arr);
        userlog(" user_id          : %s",prob_rec.user_id);
		userlog(" workstation_id   : %s",prob_rec.workstation_id);
		userlog(" action_date      : %s",prob_rec.action_date.arr);
        userlog(" action_remarks   : %s",prob_rec.action_remarks.arr);
        userlog(" action_user_id   : %s",prob_rec.action_user_id);
		userlog(" branch_code      : %s",prob_rec.branch_code);
		userlog(" txn_code         : %s",prob_rec.txn_code);
		userlog(" legacy_type      : %s",prob_rec.legacy_type);
		userlog(" probl_rec_applid : %s",prob_rec.probl_rec_applid);
        #endif

	   	if(prob_rec_ind.prob_no_ind != -1)
			probl_record->prob_no = prob_rec.prob_no;
	   	if(prob_rec_ind.id_type_ind != -1)
			strcpy(probl_record->id_type, prob_rec.id_type);
	   	if(prob_rec_ind.id_no_ind != -1)
			strcpy(probl_record->id_no, prob_rec.id_no);
	   	if(prob_rec_ind.prob_date_ind != -1)
			strcpy(probl_record->prob_date, prob_rec.prob_date.arr);
	   	if(prob_rec_ind.reason_code_ind != -1)
			strcpy(probl_record->reason_code, prob_rec.reason_code);
	   	if(prob_rec_ind.reason_srno_ind != -1)
			probl_record->reason_srno = prob_rec.reason_srno;
	   	if(prob_rec_ind.prob_stat_ind != -1)
			probl_record->prob_stat = prob_rec.prob_stat;	
	   	if(prob_rec_ind.prob_remarks_ind != -1)
			strcpy(probl_record->prob_remarks, prob_rec.prob_remarks.arr);	
	   	if(prob_rec_ind.prob_solve_date_ind != -1)
			strcpy(probl_record->prob_solve_date, prob_rec.prob_solve_date.arr);	
	   	if(prob_rec_ind.user_id_ind != -1)
			strcpy(probl_record->user_id, prob_rec.user_id);
	   	if(prob_rec_ind.workstation_id_ind != -1)
			strcpy(probl_record->workstation_id, prob_rec.workstation_id);
	   	if(prob_rec_ind.action_date_ind != -1)
			strcpy(probl_record->action_date, prob_rec.action_date.arr);
	   	if(prob_rec_ind.action_remarks_ind != -1)
			strcpy(probl_record->action_remarks, prob_rec.action_remarks.arr);
	   	if(prob_rec_ind.action_user_id_ind != -1)
			strcpy(probl_record->action_user_id, prob_rec.action_user_id);
	   	if(prob_rec_ind.branch_code_ind != -1)
			strcpy(probl_record->branch_code, prob_rec.branch_code);
	   	if(prob_rec_ind.txn_code_ind != -1)
			strcpy(probl_record->txn_code, prob_rec.txn_code);
	   	if(prob_rec_ind.legacy_type_ind != -1)
			strcpy(probl_record->legacy_type, prob_rec.legacy_type);
		if(prob_rec_ind.probl_rec_applid_ind != -1)
			strcpy(probl_record->probl_rec_applid, prob_rec.probl_rec_applid);
		
		#ifdef DEBUG		    
		    userlog("get_probl_record : Record selected successfully");
		#endif
		probl_record++;
...
//Added by Salmi on 11 Aug 2021, MyKAS Tamat Tempoh-End