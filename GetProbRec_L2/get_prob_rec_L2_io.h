...
typedef struct prob_details2
{
	...
	char txn_code[TRANSACTION_CODE_SIZE];
	char legacy_type[AGENCY_TYPE_SIZE];
	char probl_rec_applid[APP_ID_SIZE];   //Added by Salmi on 22 Aug 2021 for MyKas tamat tempoh
} PROB_DETAILS2_T;
...
#endif /* #ifndef _GET_PROB_REC_L2_IO_ */
