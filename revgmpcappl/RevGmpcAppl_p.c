...
/* Object interface: IRevGmpcApplService, ver. 0.0,
   GUID={0x500F2B9D,0x0B9D,0x4BFF,{0xA5,0xA6,0x97,0x57,0xC6,0xF9,0xB9,0x48}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IRevGmpcApplService_ServerInfo;
...
static const unsigned short IRevGmpcApplService_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IRevGmpcApplService_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IRevGmpcApplService_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IRevGmpcApplService_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IRevGmpcApplService_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(8) _IRevGmpcApplServiceProxyVtbl = 
{
    &IRevGmpcApplService_ProxyInfo,
    &IID_IRevGmpcApplService,
    ...
    (void *)-1 /* IRevGmpcApplService::Execute */
};


static const PRPC_STUB_FUNCTION IRevGmpcApplService_table[] =
{
...
CInterfaceStubVtbl _IRevGmpcApplServiceStubVtbl =
{
    &IID_IRevGmpcApplService,
    &IRevGmpcApplService_ServerInfo,
    8,
    &IRevGmpcApplService_table[-3],
...
const CInterfaceProxyVtbl * _RevGmpcAppl_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IRevGmpcApplServiceProxyVtbl,
    0
};

const CInterfaceStubVtbl * _RevGmpcAppl_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IRevGmpcApplServiceStubVtbl,
    0
};

PCInterfaceName const _RevGmpcAppl_InterfaceNamesList[] = 
{
    "IRevGmpcApplService",
    0
};

const IID *  _RevGmpcAppl_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _RevGmpcAppl_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _RevGmpcAppl, pIID, n)

int __stdcall _RevGmpcAppl_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_RevGmpcAppl_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo RevGmpcAppl_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _RevGmpcAppl_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _RevGmpcAppl_StubVtblList,
    (const PCInterfaceName * ) & _RevGmpcAppl_InterfaceNamesList,
    (const IID ** ) & _RevGmpcAppl_BaseIIDList,
    & _RevGmpcAppl_IID_Lookup, 
    1,
    2,
