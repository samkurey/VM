...
const IID *  _Jpnhg3PymtEnq_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _Jpnhg3PymtEnq_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Jpnhg3PymtEnq, pIID, n)

int __stdcall _Jpnhg3PymtEnq_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_Jpnhg3PymtEnq_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo Jpnhg3PymtEnq_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Jpnhg3PymtEnq_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Jpnhg3PymtEnq_StubVtblList,
    (const PCInterfaceName * ) & _Jpnhg3PymtEnq_InterfaceNamesList,
    (const IID ** ) & _Jpnhg3PymtEnq_BaseIIDList,
    & _Jpnhg3PymtEnq_IID_Lookup, 
    1,
    2,
