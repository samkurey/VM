...
/********************************************************************/
/* File Name   : li_create_kpt_record .h							*/
/* Author      : Srinivasa Reddy			                        */
/* Description : This file contains io structures and function		*/
/*				 prototypes for li_create_kpt_record_p  			*/
/********************************************************************/

#ifndef _LI_CREATE_KPT_RECORD_
#define _LI_CREATE_KPT_RECORD_

typedef struct li_jpn_missed_opex_upd_misc1_s
{
...
} LI_MISSED_OPEX_MISC1_T;

typedef struct li_afis_misc1_s
{ 
...
typedef struct li_passport_info1_s
{
...
typedef struct li_jpn_missed_opex_upd1_req_s
{
	NAME_T appnt_name;
	ADDRESS_T new_address;
	LI_MISSED_OPEX_MISC1_T misc;
	LI_AFIS_MISC1_T afis_misc;
	LI_PASSPORT_INFO1_T pp_info;
...
} LI_JPN_MISSED_OPEX_UPD1_REQ_T;

/* Utility functions (for internal use only) */
long get_buffer_size9(LI_JPN_MISSED_OPEX_UPD1_REQ_T *req);
int copy_images9(LI_JPN_MISSED_OPEX_UPD1_REQ_T *req, char **in_temp_ptr, int *error_code);

int li_create_kpt_record_p(LI_P_HEADER_T header,	LI_PUT_FIN_DATA_T put_fin_data,
					LI_JPN_MISSED_OPEX_UPD1_REQ_T req,
