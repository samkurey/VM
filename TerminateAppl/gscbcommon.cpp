...
{12,4274,178,0,0,
5,0,0,1,0,0,29,105,0,0,0,0,0,1,0,
20,0,0,2,0,0,31,147,0,0,0,0,0,1,0,
35,0,0,3,58,0,4,216,0,0,2,1,0,1,0,2,1,0,0,1,9,0,0,
58,0,0,4,71,0,4,288,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
81,0,0,5,71,0,4,292,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
104,0,0,6,71,0,4,296,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
127,0,0,7,72,0,4,300,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
150,0,0,8,121,0,3,490,0,0,6,6,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,1,1,0,0,1,3,0,0,
1,9,0,0,
189,0,0,9,0,0,29,503,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[7]; } branch_code;
	...
	else
	{
		...
		strcpy((char *)branch_code.arr, header.branch_code);
		setlen(branch_code);
	}
...
struct { unsigned short len; unsigned char arr[9]; } leg_branchcode;
	...
	strcpy((char *)branchcode.arr, branch_code);
	setlen(branchcode);
...
e BRANCHCODE=:b2";
	...
	strcpy(leg_branch_code, (char *)leg_branchcode.arr);
...
struct { unsigned short len; unsigned char arr[161]; } hv_err_msg
 = {0};
	...
	*/
	...
	if (strcmp(resp_msg,""))
	{
		strcpy((char *)hv_err_msg.arr, resp_msg);
		hv_err_msg.len = strlen((char *)hv_err_msg.arr);
		hv_err_msg_ind = 0;
	}
