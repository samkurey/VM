...
/* Object interface: ITerminateApplService, ver. 0.0,
   GUID={0x8B80608A,0xF7C7,0x4684,{0x90,0xF3,0xB7,0x04,0xA9,0x9F,0x4C,0xF1}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ITerminateApplService_ServerInfo;
...
static const unsigned short ITerminateApplService_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO ITerminateApplService_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &ITerminateApplService_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO ITerminateApplService_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &ITerminateApplService_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(8) _ITerminateApplServiceProxyVtbl = 
{
    &ITerminateApplService_ProxyInfo,
    &IID_ITerminateApplService,
    ...
    (void *)-1 /* ITerminateApplService::Execute */
};


static const PRPC_STUB_FUNCTION ITerminateApplService_table[] =
{
...
CInterfaceStubVtbl _ITerminateApplServiceStubVtbl =
{
    &IID_ITerminateApplService,
    &ITerminateApplService_ServerInfo,
    8,
    &ITerminateApplService_table[-3],
...
const CInterfaceProxyVtbl * _TerminateAppl_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ITerminateApplServiceProxyVtbl,
    0
};

const CInterfaceStubVtbl * _TerminateAppl_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ITerminateApplServiceStubVtbl,
    0
};

PCInterfaceName const _TerminateAppl_InterfaceNamesList[] = 
{
    "ITerminateApplService",
    0
};

const IID *  _TerminateAppl_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _TerminateAppl_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _TerminateAppl, pIID, n)

int __stdcall _TerminateAppl_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_TerminateAppl_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo TerminateAppl_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _TerminateAppl_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _TerminateAppl_StubVtblList,
    (const PCInterfaceName * ) & _TerminateAppl_InterfaceNamesList,
    (const IID ** ) & _TerminateAppl_BaseIIDList,
    & _TerminateAppl_IID_Lookup, 
    1,
    2,
