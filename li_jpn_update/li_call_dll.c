			...
			char *sErrMessage)
{
	...
	{
		userlog("get workstation id < 4 : %s",put_header.workstation_id);
...
//		strcpy(ws_seq_no, put_header.workstation_id);
	...
	userlog("msg_header->trans_machine: %d",msg_header->trans_machine);
	...
	userlog("msg_header->request_id: %s",msg_header->request_id);
	...
	userlog("msg_header->branch_code: %s",msg_header->branch_code);
	...
	userlog("msg_header->trans_code: %s",msg_header->trans_code);
