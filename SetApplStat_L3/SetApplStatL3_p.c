...
/* Object interface: ISetApplStatL3Service, ver. 0.0,
   GUID={0xBFDCE839,0x36EB,0x4cdf,{0xA6,0x7C,0xAD,0xE7,0xE7,0x7B,0x45,0x7D}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ISetApplStatL3Service_ServerInfo;
...
static const unsigned short ISetApplStatL3Service_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO ISetApplStatL3Service_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &ISetApplStatL3Service_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO ISetApplStatL3Service_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &ISetApplStatL3Service_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(8) _ISetApplStatL3ServiceProxyVtbl = 
{
    &ISetApplStatL3Service_ProxyInfo,
    &IID_ISetApplStatL3Service,
    ...
    (void *)-1 /* ISetApplStatL3Service::Execute */
};


static const PRPC_STUB_FUNCTION ISetApplStatL3Service_table[] =
{
...
CInterfaceStubVtbl _ISetApplStatL3ServiceStubVtbl =
{
    &IID_ISetApplStatL3Service,
    &ISetApplStatL3Service_ServerInfo,
    8,
    &ISetApplStatL3Service_table[-3],
...
const CInterfaceProxyVtbl * _SetApplStatL3_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISetApplStatL3ServiceProxyVtbl,
    0
};

const CInterfaceStubVtbl * _SetApplStatL3_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISetApplStatL3ServiceStubVtbl,
    0
};

PCInterfaceName const _SetApplStatL3_InterfaceNamesList[] = 
{
    "ISetApplStatL3Service",
    0
};

const IID *  _SetApplStatL3_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _SetApplStatL3_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SetApplStatL3, pIID, n)

int __stdcall _SetApplStatL3_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_SetApplStatL3_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo SetApplStatL3_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SetApplStatL3_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SetApplStatL3_StubVtblList,
    (const PCInterfaceName * ) & _SetApplStatL3_InterfaceNamesList,
    (const IID ** ) & _SetApplStatL3_BaseIIDList,
    & _SetApplStatL3_IID_Lookup, 
    1,
    2,
